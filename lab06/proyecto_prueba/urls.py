...
from .views import *
from cursos.views import login, profile, administrador, inicio, registrarDocentes, docentes,editarDocentes,logout,autentifiToken, estadoDocente, asignaturas,agregarGrupoLab, alumno,laboratorios
